...
public class BlockHighlightParticle extends AbstractParticle {
    public BlockHighlightParticle(WizardryParticleOptions options, ClientLevel level, double x, double y, double z, double xd, double yd, double zd, @NonNull MutableDoubleSpriteSet sprites) {

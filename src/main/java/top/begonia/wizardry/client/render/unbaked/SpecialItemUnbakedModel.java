...
public record SpecialItemUnbakedModel(Identifier modelId) implements ItemModel.Unbaked {

    public static final MapCodec<SpecialItemUnbakedModel> MAP_CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
                    Identifier.CODEC.fieldOf("model").forGetter(SpecialItemUnbakedModel::modelId)
            ).apply(instance, SpecialItemUnbakedModel::new)
    );

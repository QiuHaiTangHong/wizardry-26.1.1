...
public class GlowUnbakedModel extends DelegateUnbakedModel {
    public GlowUnbakedModel(UnbakedModel delegate) {
        super(delegate);
    }
    ...
    public UnbakedGeometry geometry() {
        ...
        return new UnbakedGeometry() {
            ...
            public @NonNull QuadCollection bake(@NonNull TextureSlots textureSlots, @NonNull ModelBaker modelBaker, @NonNull ModelState modelState, @NonNull ModelDebugName modelDebugName) {
                return Objects.requireNonNull(GlowUnbakedModel.super.geometry()).bake(textureSlots, modelBaker, modelState, modelDebugName);
            }

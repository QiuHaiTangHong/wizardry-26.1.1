...
public abstract class AbstractSpell implements Comparable<AbstractSpell> {
    public static ImmutableMap<Identifier, SpellProperties> spellProperties;
    ...
    public SpellProperties getProperties() {
        if (spellProperties == null || !spellProperties.containsKey(this.identifier)) {
            return SpellProperties.getDefault();
        } else if (properties == null) {
            properties = spellProperties.getOrDefault(this.identifier, SpellProperties.getDefault());
            return properties;
        } else {
            return properties;
        }

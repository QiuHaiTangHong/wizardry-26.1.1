...
public abstract class SpellCastEvent extends Event {
    ...
    public static class Pre extends SpellCastEvent implements ICancellableEvent {
        ...
        public Pre(Source source, AbstractSpell spell, LivingEntity caster, SpellContextFlow contextFlow) {
    ...
    public static class Tick extends SpellCastEvent implements ICancellableEvent {
        ...
        public Tick(Source source, AbstractSpell spell, LivingEntity caster, SpellContext context, int count) {
            super(source, spell, caster);
            this.count = count;
            this.context = context;
        }

        public Tick(Source source, AbstractSpell spell, Level level, double x, double y, double z, Direction direction, SpellContext context, int count) {
            super(source, spell, level, x, y, z, direction);
            this.count = count;
            this.context = context;
        }

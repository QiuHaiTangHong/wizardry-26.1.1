...
public final class SpellContextFlow {
    ...
    private SpellContextFlow(@NonNull LivingEntity caster, InteractionHand hand, ItemStack staffStack) {
        this.caster = caster;
        this.hand = hand;
        this.staffStack = staffStack;
    }

    public static @NonNull SpellContextFlow create(@NonNull LivingEntity caster, InteractionHand hand, ItemStack staffStack) {
        return new SpellContextFlow(caster, hand, staffStack);
    }
